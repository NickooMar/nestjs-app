...
const Signin = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-rose-900 dark:bg-[#111827] dark:bg-dot-white/[0.2] bg-dot-black/[0.2]">
      <div className="-z-10 flex absolute pointer-events-none inset-0 items-center justify-center  dark:bg-black bg-rose-600 [mask-image:radial-gradient(ellipse_at_center,transparent_40%,black)] opacity-45" />
      <div className="z-10 w-full max-w-xl p-4 bg-white border border-gray-200 rounded-xl shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 ">
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          {!isLoading ? (
            <button
              type="submit"
              className="w-full text-white bg-rose-600 hover:bg-rose-800 focus:ring-4 focus:outline-none focus:ring-rose-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              {t('signin.title')}
            </button>
          ) : (
